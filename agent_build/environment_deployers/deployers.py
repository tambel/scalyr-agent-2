...
# when those deployers are executed, they run their shell scripts.
...
#       python3 deployers.py <deployer_name> dump-checksum
#
...
class EnvironmentDeployer:
    ...
    def get_image_name(self, base_docker_image: str):
        return f"scalyr-build-deployer-{self.get_used_files_checksum()}-{base_docker_image}".lower()
...
if __name__ == '__main__':
    ...
    deployer_cls = DEPLOYERS[args.deployer_name]
