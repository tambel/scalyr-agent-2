...
_SOURCE_ROOT = _PARENT_DIR.parent.parent.parent
...
from agent_build.tools import build_in_docker, constants
...
COMMON_TEST_ENVIRONMENT = Deployment(
    name="test_environment",
    architecture=constants.Architecture.NOARCH,
    step_classes=[
        InstallBuildRequirementsStep,
        InstallTestRequirementsDeploymentStep
    ],
)
